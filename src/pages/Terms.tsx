    ...
    <div className="max-w-4xl mx-auto bg-slate-50 rounded-2xl p-8 shadow-lg">
     ...
     <section className="mb-8">
      ...
      <p className="text-slate-600">
       By accessing and using InnoBoost's services, you accept and agree to be
     ...
     <section className="mb-8">
      ...
      <p className="text-slate-600 mb-4">
       InnoBoost provides digital marketing services including but not limited
       to:
      </p>
     ...
     <section className="mb-8">
      ...
      <p className="text-slate-600">
       All content, features, and functionality are owned by InnoBoost and are
     ...
     <section>
      ...
      <p className="text-slate-600">
       ...
       <br />
       Address: 15C1 Milton House, Town Range, Gibraltar
      </p>
     </section>
    </div>
   </div>
